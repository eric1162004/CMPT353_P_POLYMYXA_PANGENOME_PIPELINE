...
1. Ensure the raw **_P. polymyxa_** GFF3 files are correctly placed within the `data/` directory.
...
3. Run the cells sequentially. The notebook will automatically import the modules from `src/` to:
   ...
   - **Stratify the Pangenome:** Genes are grouped by frequency into **Core** (>95%), **Shell** (15 - 95%), and **Cloud** (<15%) layers.
...
To obtain the exact 62 **_Paenibacillus polymyxa_** strains analyzed in the Maggi et al. (2024) study, follow these steps:
